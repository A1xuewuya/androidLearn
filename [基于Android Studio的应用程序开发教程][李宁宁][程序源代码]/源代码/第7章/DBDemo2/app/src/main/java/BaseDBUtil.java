...
public class BaseDBUtil {
    ...
    public static  Integer copyDatabaseFile(Context context) {
        ...
        Integer res = -1;
        try {
           // InputStream inputStream = context.getResources().getAssets().open(DB_NAME);
            InputStream inputStream =context.getClass().getClassLoader().getResourceAsStream("assets/"+DB_NAME);
