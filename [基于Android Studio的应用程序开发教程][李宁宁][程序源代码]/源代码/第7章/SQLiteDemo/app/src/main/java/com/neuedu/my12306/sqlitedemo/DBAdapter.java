...
public class DBAdapter {
	...
	{
		private static final String DB_CREATE="create table "+DB_TABLE+"("+KEY_ID+" integer primary key autoincrement, "+KEY_NAME+" text not null, "+KEY_PHONE_NUMBER+" text,"+KEY_ADDRESS+" text,"+KEY_E_MAIL+" text);";
