...
public class OrderAdapter extends FoodBaseAdapter{
...
public OrderAdapter(Context context, List<Order> data) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		holder.food_detail.setText(price+"*"+num+"="+listItems.get(position).getSum()+"元");
		try{
	...
	class Holder {
		TextView food_name,food_detail,shop_name,shop_address;
		Button btn_comment;
	}
